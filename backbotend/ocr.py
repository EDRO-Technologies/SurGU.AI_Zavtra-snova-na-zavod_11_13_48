...
def convert_to_images(input_file,):
    images = convert_from_path(input_file, poppler_path='C:/Users/kit/Downloads/poppler-24.08.0/Library/bin')
    image = images[0]
...
for pagenum, page in enumerate(extract_pages(pdf_path)):
    ...
    # result = ''.join(text_per_page["Page_2"][0])
    result = ''.join(text_per_page[f"Page_{str(pagenum)}"][4])
    print(result)
