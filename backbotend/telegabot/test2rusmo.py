...
def test2rusmo(question, text):
  print("questionAAAAAAAAAAAAAa",question)
  print("texttexttexttexttexttexttexttexttexttexttexttext",text)
  # question = ''
  # text = ''
  ...
  if not answer:
    ...
    answer = answer + f" <i>(Информация взята из следующего места в файле: начало {start_index}, конец {end_index+1})</i>"
